		...
		<div id="top-header">
			<div class="container">
				...
				<ul class="header-links pull-right">
					<li><a href="controlador/logout.php"><i class="fa fa-dollar">Cerrar Session</i></a></li>
...
<header
		...
		<div id="top-header">
			<div class="container">
				...
				<ul class="header-links pull-right">
					<li><a href="#" data-toggle="modal" data-target="#iniciar_seccion"><i class="fa fa-dollar"></i> Iniciar Session</a></li>
